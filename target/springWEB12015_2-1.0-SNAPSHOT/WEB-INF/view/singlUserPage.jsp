...
<div class="w3-container w3-content" style="max-width:1900px;margin-top:80px">
    <div class="w3-row">
        <div class="w3-col m3">
            ...
            <button onclick="document.getElementById('createPost').style.display='block'" class="w3-button w3-block w3-theme-l1 w3-left-align">Додати пост</button>

            <div id="createPost" class="w3-modal">
                <div class="w3-modal-content">
                    <div class="w3-container">
                        <span onclick="document.getElementById('createPost').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                        <br><br>
                        <sf:form action="/post/savePost" method="post" modelAttribute="emptyPost" enctype="multipart/form-data">
                            <sf:input class="form-control" placeholder="Введіть назву посту" path="title" required="required"/><br>
                            <sf:textarea class="form-control" placeholder="Введіть пост" path="descript" required="required"/><br>
        ...
        <div class="w3-col m7">
            ...
            <c:forEach items="${posts}" var="post">
                ...
                <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                    ...
                    <img src="${post.images}" alt="" style="width:300px; cursor:pointer"  class="w3-hover-opacity w3" onclick="onClick(this)">
                    <p>${post.descript}</p>
                    <br>
                    <form>
