                        ...
                        <ul id="myUL" class="w3-ul w3-card-4">
                            ...
                            <li class="w3-bar">
                                <c:if test = "${currentUser.roles == 'ROLE_ADMIN'}">
                                    <button class="w3-bar-item w3-button w3-white w3-right" onClick='location.href="deleteUser-${user.id}"'><i class="fa fa-close"></i></button>
                                </c:if>
                                <img src="${user.avatar}" alt="" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
