                            ...
                            <li class="w3-bar">
                                <c:if test="${user.roles == 'ROLE_ADMIN'}">
                                    <button class="w3-margin-bottom w3-right"
                                            onClick='location.href="/category/deleteCategory-${category.id}"'><i
                                            class="fa fa-close"></i></button>
                                </c:if>
                                <div class="w3-bar-item">
                                    <span><a
                                            href="/category/showCategory-${category.id}">${category.name}</a></span><br>
                                </div>
                                </c:forEach>
                            </li>
                        </ul>
        ...
        <div class="w3-col m7">
            ...
            <c:forEach items="${posts}" var="post">
                <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                    ...
                    <img src="${post.images}" alt="" style="width:550px; cursor:pointer" class="w3-hover-opacity w3"
