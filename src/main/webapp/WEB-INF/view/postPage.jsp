        ...
        <div class="w3-col m7">
            ...
            <div class="w3-row-padding">
                ...
                <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                    ...
                    <img src="${post.images}" alt="" style="width:500px; cursor:pointer"  class="w3-hover-opacity w3" onclick="onClick(this)">
                    <p>${post.descript}</p>
                    <br>
                    <h5>Автор: <a href="/user/show-${post.user.id}">${post.user.username}</a></h5>

                <h5><b>Коментувати :</b></h5>
                <sf:form action="/comment/saveComment" method="post" modelAttribute="emptyComment">
                    ...
                    <button type="submit" class="w3-button w3-theme w3-right"><i class="fa fa-pencil"></i>Додати</button>
                </sf:form><br>

                <%--<button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align">Переглянути коментарі</button><br>--%>
                <%--<div id="Demo1" class="w3-container w3-hide">--%>
                    <c:forEach items="${comments}" var="comment"><hr>
                        <c:if test = "${user.roles == 'ROLE_ADMIN'}">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img src="${comment.user.avatar}" alt="" class="media-object" style="width:45px">
                            </div>
