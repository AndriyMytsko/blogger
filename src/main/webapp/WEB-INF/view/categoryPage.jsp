            ...
            <div class="w3-card-2 w3-round w3-white">
                <div class="w3-container">
                    ...
                    <sec:authorize access="isAuthenticated()">
                        <p class="w3-center"><img src="${category.avatar}" alt="" style="height:260px;width:240px;
                                cursor:pointer" onclick="onClick(this)" class="w3-hover-opacity w3"></p>
                        <div class="w3-container w3-myfont">
                            <p class="w3-center w3-xxxlarge">${category.name}</p>
                        </div>
                    </sec:authorize>
                </div>
            </div>
        ...
        <div class="w3-col m7">
                    ...
                    <div class="w3-card-2 w3-round w3-white">
                        <div class="w3-container w3-padding">
                            <img class="media-object img-circle"
                                 src="http://status-m.com.ua/images/pages/589c51f8c3eb6.png" style="width: 60%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                ...
                <sf:form action="/post/savePost" method="post" modelAttribute="emptyPost" enctype="multipart/form-data">
                    <h6>Назва посту</h6>
                    <sf:input class="form-control" path="title" required="required"/>
                    <br>
                    <sf:textarea class="form-control" path="descript" required="required"/>
                    <br>
            ...
            <c:forEach items="${posts}" var="post">
                <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                    ...
                    <c:if test="${user.roles == 'ROLE_ADMIN'}">
                        <button class="w3-margin-bottom w3-right" onClick='location.href="/post/deletePost-${post.id}"'>
